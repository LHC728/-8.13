...
- **不实现 H2**（Q3/H2 BOOTSTRAP 设计已冻结但实现未授权；P0 key schema 已 accepted 且 P0 已关闭）；**Q3 H1 七 K 正式基线（Tier 1 + Tier 2）accepted；Q3 七 K H2 opportunity-density recheck temporal requalification（E1）与 fragment-aware checker requalification（E2）= COMPLETED / AWAITING HUMAN GATE FINAL REVIEW（本包关闭）**；**不运行 H2 tuning / holdout / formal 实验、不运行 Tier 3、不运行 P1 / C23 / C25**（须 Human Gate 另发授权）；**不推荐 Q3 K**（无已批准 final Q3 K 推荐；k\*=K12 为预注册统计报告，措辞限于七个 K + 冻结 H1 政策集）；
