...
Role
----
This module is the INDEPENDENT oracle (E2) for task package G2-02-SPEC-V1.0.5
...
# --------------------------------------------------------------------------
# Frozen constants (from task package G2-02-SPEC-V1.0.5 and shared schema)
# --------------------------------------------------------------------------
...
# previous active G2-02-SPEC-V1.0.4 -- is refused during load (VALIDATION
# ERROR, exit 2).  startswith/multi-version acceptance is never allowed.
# V1.0.5 = provenance-clean upstream rebind only; checker logic unchanged.
TASK_PACKAGE_VERSION = "G2-02-SPEC-V1.0.5"
