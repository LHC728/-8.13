...
# ---- V1.0.5 frozen bindings (documented + enforced for spec/version/hashes) ----
# V1.0.5 = provenance-clean upstream rebind only: canonical upstream switched
# from historical G2-01 run_..._f1290916 to clean reissue run_..._8babb503;
# schema/fixture/parameters hashes unchanged from V1.0.4; no mathematical change.
SPEC_VERSION = "G2-02-SPEC-V1.0.5"
