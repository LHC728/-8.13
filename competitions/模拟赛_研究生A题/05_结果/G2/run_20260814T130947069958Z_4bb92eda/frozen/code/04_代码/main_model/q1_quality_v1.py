...
Implements the frozen G2-02-SPEC-V1.0.5 Q1 chain: stage_0 upstream A/B/C kernels
(V1.0.5 = provenance-clean upstream rebind only, canonical upstream switched to
clean G2-01 reissue; mathematical logic unchanged from V1.0.3/V1.0.4), stage_1
closed-form q_E, stage_2 E kernel calibration (reusing the accepted
observation_calibration_v1 solver), stage_3 E rates, stage_4 final fourfold with
E[S]/E[PL]/E[PW], stage_5 lambda (event-level main table + tilde) and multinomial,
all cross-checked across three independent routes (closed form / 16-state
enumeration / absorption chain).
...
FROZEN_UPSTREAM_SHA256 = {
    SINGLE: "afc6f8b20635af3a6414ff41f5d2a86c39892103c272d603e557817b5db993c7",
    CHAIN: "49bad533cdacd2309c697f52636ebca8a895795c6247aea65e711911bcddae76",
}
# G2-02-SPEC-V1.0.5 frozen bindings (task package frozen_sha256; V1.0.5 =
# provenance-clean upstream rebind only, upstream switched to clean G2-01
# reissue run_20260814T130221390333Z_8babb503; mathematical logic unchanged).
