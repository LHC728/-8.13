...
UPSTREAM_ROOT = PROJECT / "05_结果/G2/run_20260814T130221390333Z_8babb503"
...
FROZEN_SPEC_VERSION = "G2-02-SPEC-V1.0.5"
FROZEN_UP_SINGLE_SHA256 = "afc6f8b20635af3a6414ff41f5d2a86c39892103c272d603e557817b5db993c7"
FROZEN_UP_CHAIN_SHA256 = "49bad533cdacd2309c697f52636ebca8a895795c6247aea65e711911bcddae76"
TOL = Decimal("1e-15")
...
class TestCanonicalRuns(Q1ChainTestCase):
    def make_canonical_request(self, semantics: str) -> dict:
        ...
        file_rel = f"05_结果/G2/run_20260814T130221390333Z_8babb503/{semantics}/response.json"
        return {
            "schema_version": "q1_quality_v1",
            "envelope_type": "q1_request",
            "request_id": f"20260814T130221390333Z_8babb503:{semantics}",
            "scenario_role": "canonical_g2_02",
            "semantics": semantics,
            "upstream": {
                "mode": "bound_frozen",
                "reference": {
                    "run_id": "20260814T130221390333Z_8babb503",
                    "file": file_rel,
                    "sha256": up_hash,
